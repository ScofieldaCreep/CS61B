...
public class NBodyExtreme {
    ...
    public static PlanetExtreme spaceShip = new PlanetExtreme(2.2790e+11, 0, 0, 2.4100e+04,  6.4190e+23,  "spaceship.png");
    ...
    public static void main(String[] args) {
        ...
        PlanetExtreme[] bodies = NBodyExtreme.readBodies(filename);
    ...
    public static void moveSpaceCraft(double dt, PlanetExtreme[] bodies) {
    ...
    public static PlanetExtreme[] readBodies(String filename){
        In in = new In(filename);
        int number = in.readInt();
        double radius = in.readDouble();

        PlanetExtreme[] allBodys = new PlanetExtreme[number];
        int i = 0; 
        while (i != number) {
            ...
            allBodys[i]  = new PlanetExtreme(xPos, yPos, xVel, yVel, mass, img);
            i += 1;
